<div class="card">
    ...
    <div class="card-body">
        ...
        <form id="add_edit_user_form" class="form"
            action="{{ isset($edit_user_details) && $edit_user_details == true ? route('superadmin.users.post_edit_user', ['user_id' => $user_details->id]) : route('superadmin.users.post_add_user') }}"
